...
/*
worldStore.statereftxdata
worldStore.state.refwd
Dispatcher.registerCallback('GET_REF_TX',function(){
Dispatcher.registerCallback('REQ_REF_WD',function(params){
Dispatcher.registerCallback('UPDATE_REF_WD', function(newamnt) {
*/
     ...
     render: function() {
       ...
       return el.div(
                ...
                el.div({className:'well well-sm'},
                  ...
                  el.div({className:'text text-center'},
                      ...
                      worldStore.state.reftxdata.map(function(record) {
                        return el.tr(
                         { key: record._id},
                           ...
                           el.td(
                             null,
                             el.span({className: 'label ' + record.stats == 'COMPETE' ? 'label-success': 'label-warning'},record.status)
                           )
                        );
                      }).reverse()
                    )
